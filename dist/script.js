...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    if (sizeBlock.value == '' || materialBlock.value == '') {
      ...
      if (resultBlock.textContent == sum) {
        state.price = sum;
        console.log(state);
      }
    }
...
/* harmony import */ var _calc__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./calc */ "./src/js/modules/calc.js");
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      e.preventDefault(); //отмена перезагруки страницы
      ...
      formData.append('price', _calc__WEBPACK_IMPORTED_MODULE_5__["state"].price);
      var api;
...
var modals = function modals() {
  ...
  function showModalByTime(modalSelector, time, presentSelector) {
    var destroy = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    setTimeout(function () {
      var display;
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_5__["getResource"])("assets/db.json").then(function (res) {
